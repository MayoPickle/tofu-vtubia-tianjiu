...
function SpinWheel({ prizes, result, setResult, mode = LOTTERY_MODES.PRIZE_MODE, members = [], gift = null }) {
  ...
  const renderParticipants = () => {
    ...
    participantsRef.current.forEach(participant => {
      ...
      if (probability >= 3) {
        // 高倍率：金色边框 + 发光
        element.style.border = '4px solid #e3bb4d';
        element.style.boxShadow = '0 0 15px rgba(227, 187, 77, 0.6), 0 4px 12px rgba(168, 143, 106, 0.3)';
      } else if (probability >= 2) {
        // 中倍率：银色边框 + 淡发光
        element.style.border = '3px solid #C0C0C0';
        element.style.boxShadow = '0 0 10px rgba(192, 192, 192, 0.5), 0 4px 12px rgba(168, 143, 106, 0.3)';
      } else {
        // 普通倍率：白色边框
        element.style.border = '3px solid #fff';
        element.style.boxShadow = '0 4px 12px rgba(168, 143, 106, 0.3)';
      }
      ...
      if (participant.hasAvatar && participant.image) {
        ...
        element.style.backgroundColor = '#2e3548';
      } else {
        // 显示默认图标
  ...
  const moveWinnerToOutlet = (winner, chosen) => {
    ...
    const moveAnimation = () => {
      ...
      if (winnerElement) {
        winnerElement.style.boxShadow = `0 0 ${20 + animProgress * 20}px #e3bb4d, 0 0 ${40 + animProgress * 40}px #d4a942`;
        winnerElement.style.border = '4px solid #e3bb4d';
      }
  ...
  return (
    <div style={{ 
      ...
      margin: '0 auto',
      background: `
        linear-gradient(145deg, rgba(28, 33, 52, 0.95) 0%, rgba(46, 53, 72, 0.95) 100%),
        radial-gradient(circle at top left, rgba(168, 143, 106, 0.1) 0%, transparent 50%),
        radial-gradient(circle at bottom right, rgba(227, 187, 77, 0.1) 0%, transparent 50%)
      `,
      borderRadius: '24px', // 增大圆角
      boxShadow: '0 12px 40px rgba(168, 143, 106, 0.25), 0 0 20px rgba(198, 163, 115, 0.3)', // 增强阴影
      border: '3px solid rgba(196, 163, 115, 0.4)', // 稍微增强边框
      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: isAnimating 
                    ? 'radial-gradient(circle, #e3bb4d 20%, #d4a942 60%, #b8860b 100%)'
                    : 'radial-gradient(circle, #a88f6a 30%, #917752 70%, #654321 100%)',
                  border: '2px solid #a88f6a',
                  boxShadow: isAnimating 
                    ? '0 0 8px #e3bb4d, inset 0 2px 4px rgba(255, 255, 255, 0.3)'
                    : '0 0 3px #917752, inset 0 2px 4px rgba(255, 255, 255, 0.1)',
          ...
          <div 
            ...
            style={{ 
              ...
              border: '8px solid #a88f6a',
              borderRadius: '20px 20px 10px 10px', // 底部圆角小一点，为出奖口让路
              position: 'relative',
              background: `
                #1c2134,
                radial-gradient(circle at 20% 20%, rgba(198, 163, 115, 0.8) 0%, transparent 50%),
                radial-gradient(circle at 80% 80%, rgba(168, 143, 106, 0.6) 0%, transparent 50%),
                radial-gradient(circle at 40% 60%, rgba(145, 119, 82, 0.4) 0%, transparent 50%),
                linear-gradient(45deg, rgba(168, 143, 106, 0.15), rgba(53, 42, 70, 0.15))
              `,
              overflow: 'hidden',
              boxShadow: 'inset 0 0 30px rgba(168, 143, 106, 0.3), 0 0 20px rgba(198, 163, 115, 0.4)'
            }}
          >
            {/* 内部装饰性元素 */}
            {/* 浮动的小星星 */}
            ...
            <div style={{
              ...
              height: '40px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(168, 143, 106, 0.3) 0%, transparent 70%)',
            ...
            <div style={{
              ...
              height: '30px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(227, 187, 77, 0.25) 0%, transparent 70%)',
          ...
          <div style={{
            ...
            overflow: 'hidden',
            boxShadow: 'inset 0 5px 15px rgba(168, 143, 106, 0.4)'
          }}>
            {/* 出奖口门 */}
            <div style={{
              position: 'absolute',
              ...
              width: '100%',
              height: '100%',
              background: 'linear-gradient(180deg, #352a46, #a88f6a)',
        ...
        {winnerAtOutlet && (
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              border: '5px solid #e3bb4d',
              boxShadow: '0 0 30px #e3bb4d, 0 0 60px #d4a942',
              backgroundImage: winnerAtOutlet.hasAvatar && winnerAtOutlet.image ? `url(${winnerAtOutlet.image})` : 'none',
              backgroundColor: winnerAtOutlet.hasAvatar ? '#2e3548' : themeColor,
        ...
        <Button 
          ...
          style={{ 
            ...
            boxShadow: '0 10px 25px rgba(168, 143, 106, 0.4)', // 增强阴影
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            gap: '10px' // 增大图标与文字间距
        ...
        <div style={{
          ...
          <br />
          <span style={{ fontSize: isMobile ? '15px' : '16px', color: '#e6d6bc', fontWeight: 'normal' }}> {/* 增大说明文字 */}
            💫 头像大小 = 中奖倍率 | 🥇 ≥3倍 🥈 ≥2倍 🤍 普通
          </span>
        </div>
      </div>
      ...
      <style jsx="true">{`
        @keyframes pulse {
          0% {
            ...
            box-shadow: 0 0 30px #e3bb4d, 0 0 60px #d4a942;
          }
          50% {
            transform: scale(1.1) rotate(180deg);
            box-shadow: 0 0 50px #e3bb4d, 0 0 100px #d4a942;
          }
          100% {
        ...
        @keyframes bulb-flash {
          0% {
            opacity: 0.3;
            box-shadow: 0 0 5px #e3bb4d, inset 0 2px 4px rgba(255, 255, 255, 0.1);
            background: radial-gradient(circle, #a88f6a 20%, #917752 60%, #654321 100%);
          }
          25% {
            opacity: 0.6;
            box-shadow: 0 0 10px #e3bb4d, inset 0 2px 4px rgba(255, 255, 255, 0.2);
            background: radial-gradient(circle, #c4a373 20%, #a88f6a 60%, #917752 100%);
          }
          50% {
            opacity: 1;
            box-shadow: 0 0 15px #e3bb4d, 0 0 25px #d4a942, inset 0 2px 4px rgba(255, 255, 255, 0.4);
            background: radial-gradient(circle, #e3bb4d 20%, #d4a942 60%, #b8860b 100%);
          }
          75% {
            opacity: 0.8;
            box-shadow: 0 0 12px #e3bb4d, 0 0 20px #d4a942, inset 0 2px 4px rgba(255, 255, 255, 0.3);
            background: radial-gradient(circle, #e3bb4d 20%, #c4a373 60%, #a88f6a 100%);
          }
          100% {
            opacity: 0.3;
            box-shadow: 0 0 5px #e3bb4d, inset 0 2px 4px rgba(255, 255, 255, 0.1);
        ...
        @keyframes bulb-flash-fast {
          0% {
            opacity: 0.2;
            box-shadow: 0 0 3px #917752, inset 0 1px 2px rgba(255, 255, 255, 0.1);
            background: radial-gradient(circle, #917752 30%, #654321 70%, #4A4A4A 100%);
          }
          50% {
            opacity: 1;
            box-shadow: 0 0 20px #e3bb4d, 0 0 35px #d4a942, inset 0 2px 4px rgba(255, 255, 255, 0.5);
            background: radial-gradient(circle, #e3bb4d 10%, #d4a942 50%, #b8860b 100%);
          }
          100% {
            opacity: 0.2;
            box-shadow: 0 0 3px #917752, inset 0 1px 2px rgba(255, 255, 255, 0.1);
